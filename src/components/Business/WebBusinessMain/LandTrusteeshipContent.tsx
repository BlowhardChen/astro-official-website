import LandTrusteeshipSection from "./LandTrusteeshipSection";
import ServiceCases from "./ServiceCases";

const LandTrusteeshipContent = () => (
  <>
    <div className="relative w-full h-[1280px] overflow-hidden">
      <div className="absolute left-1/2 transform -translate-x-1/2 top-[80px]">
        <h2 className="text-3xl font-bold">土地托管</h2>
        <p className="mt-[20px] text-2xl leading-10">
        ...
        <LandTrusteeshipSection
          ...
          imageSrc="/images/business/land-img-1.webp"
          imageAlt="半托管示例"
          isImageLeft={true}
        />
        ...
        <LandTrusteeshipSection
          ...
          imageSrc="/images/business/land-img-2.webp"
          imageAlt="全托管示例"
          isImageLeft={false}
        />
      </div>
    ...
    <ServiceCases
      ...
      cases={[
        {
          imageSrc: "/images/business/business-1.webp",
          title: "帮农户测量托管地块",
          description:
        ...
        {
          imageSrc: "/images/business/business-2.webp",
          title: "为农户配送农资",
          description:
        ...
        {
          imageSrc: "/images/business/business-3.webp",
          title: "帮农户托管的地块播种",
          description:
